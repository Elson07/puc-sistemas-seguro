...
public class Calculadora {
	...
	public int somar(@WebParam(name = "numero1") int numero1, @WebParam(name = "numero2") int numero2) throws Exception {
		autenticar(context);
		return numero1 + numero2;
	}
	       
	@WebMethod(action = "subtracao")
	public int subtracao(@WebParam(name = "numero1") int numero1, @WebParam(name = "numero2") int numero2) {
		return numero1 - numero2;
	}
	
	@WebMethod(action = "multiplicacao")
	public int mutltipucacao(@WebParam(name = "numero1") int numero1, @WebParam(name = "numero2") int numero2) {
		return numero1 * numero2;
	}
	
	@WebMethod(action = "divisao")
	public double divisao(@WebParam(name = "numero1") double numero1, @WebParam(name = "numero2") double numero2) throws DivisaoPorZeroException {
		if(numero2 == 0){
	...
	private boolean autenticar (WebServiceContext context) throws Exception{
		...
		if(!httpHeaders.containsKey("senha")) {
			throw new Exception("Unforme uma senha");
		}
